...
python3 run_llm.py --model_name=mixtral:8x7b-instruct-v0.1-q4_K_M --reports_to_process=-1

python3 run_llm.py --model_name=mixtral:latest --reports_to_process=-1

python3 run_llm.py --model_name=llama3.1:latest --reports_to_process=-1

python3 run_llm.py --model_name=llama3.2:latest --reports_to_process=-1
