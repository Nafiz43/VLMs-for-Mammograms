...
Example 1:
{
    "IMG_ID_CC": "/mnt/data1/raiyan/breast_cancer/VLMs-for-Mammograms/vindr/L_CC/0a0c5108270e814818c1ad002482ce74.png",
    "IMG_ID_MLO": "/mnt/data1/raiyan/breast_cancer/VLMs-for-Mammograms/vindr/L_MLO/0a0c5108270e814818c1ad002482ce74.png",
...
Example 2:
{
    "IMG_ID_CC": "/mnt/data1/raiyan/breast_cancer/VLMs-for-Mammograms/vindr/L_CC/0a936e2a8042114394878bee2c7ef727.png",
    "IMG_ID_MLO": "/mnt/data1/raiyan/breast_cancer/VLMs-for-Mammograms/vindr/L_MLO/0a936e2a8042114394878bee2c7ef727.png",
...
def process_side(model_name, side, cc_dir, mlo_dir, report_dir, reports_to_process):
    ...
    for idx, filename in enumerate(img_files):
        ...
        saving_dir = os.path.join('evaluated-vindr/_nshot/', f"{model_name}_{side}")
